...
def get_optimizer(model_params, optimizer_args_dict):
    ...
    if name == 'sgd':
        ...
        return Lookahead(torch.optim.SGD(model_params, **new_optimizer_args_dict))
    elif name == 'adagrad':
        # return torch.optim.Adagrad(model_params, **new_optimizer_args_dict)
        return Lookahead(torch.optim.Adagrad(model_params, **new_optimizer_args_dict))
    elif name == 'adam':
        # return torch.optim.Adam(model_params, **new_optimizer_args_dict)
        return Lookahead(torch.optim.Adam(model_params, **new_optimizer_args_dict))
    elif name == 'adamw':
        #return torch.optim.AdamW(model_params, **new_optimizer_args_dict)
        return Lookahead(torch.optim.AdamW(model_params, **new_optimizer_args_dict))
    else:
